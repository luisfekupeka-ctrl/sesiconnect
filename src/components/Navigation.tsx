    ...
    <aside className={cn(
      ...
      <div className="p-6 pb-8">
        <h1 className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-2xl bg-[#42a0f5] flex items-center justify-center text-black font-black text-2xl border border-[#42a0f5]">S</div>
          <div>
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              cn(
                ...
                isActive 
                  ? "bg-[#42a0f5] text-black border border-[#42a0f5]" 
                  : "text-on-surface-variant hover:bg-surface-container-high hover:text-[#42a0f5]"
              )
            }
          >
            <item.icon size={22} />
        ...
        <NavLink
          ...
          className={({ isActive }) =>
            cn(
              ...
              isActive
                ? "bg-[#0aeb7a] text-black border-[#0aeb7a]"
                : "bg-surface-container-low text-on-surface-variant border-[#30363d] hover:border-[#0aeb7a] hover:text-[#0aeb7a]"
            )
          }
        >
          <Shield size={22} />
