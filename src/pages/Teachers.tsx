               ...
               <div className="flex-1 overflow-y-auto p-12 space-y-12 custom-scrollbar bg-surface-container-lowest">
                  ...
                  <div className="space-y-6">
                     {professorAtivo.agendaDoDia.map((aula, i) => (
                        <div key={i} className="p-10 bg-[#0d1117] rounded-[3.5rem] border border-[#30363d] group hover:border-[#42a0f5]/40 transition-all shadow-xl">
                           <div className="flex justify-between items-start mb-8">
                              <div>
                                 <p className="text-[11px] font-black text-[#42a0f5] uppercase tracking-[0.3em] mb-2">{aula.horario}</p>
                                 <h4 className="text-3xl font-black text-white italic tracking-tighter">{aula.materia}</h4>
                              </div>
                           ...
                           <div className="flex items-center justify-between pt-8 border-t border-white/5">
                              ...
                              <button 
                                ...
                                className="px-8 py-4 bg-[#42a0f5] text-black text-[11px] font-black uppercase tracking-[0.2em] rounded-2xl hover:scale-105 active:scale-95 transition-all flex items-center gap-3 shadow-xl shadow-[#42a0f5]/20"
                              >
